...
<div class="container-fluid py-4">
    @include('regulator._partials.page-header', [
        ...
        'subtitle' => 'View and manage registered insurance companies',
        'icon' => 'bi-building'
    ])
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="mb-0 text-muted">Total Insurers</h6>
                            <h4 class="mb-0 fw-bold">{{ $insurers->total() ?? 0 }}</h4>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white border-0 py-3">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0">All Insurers</h5>
                <button class="btn btn-primary btn-sm">
                    <i class="bi bi-plus-lg me-1"></i> Register New Insurer
                </button>
            </div>
        </div>
        <div class="card-body">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div class="fw-bold">{{ $insurer->name ?? 'N/A' }}</div>
                                                <small class="text-muted">ID: {{ $insurer->id ?? '-' }}</small>
                                            </div>
                                        </div>
                                    </td>
            ...
            @else
                @include('regulator._partials.empty-state', [
                    ...
                    'text' => 'No insurers have been registered yet.'
                ])
            @endif
        </div>
    </div>
