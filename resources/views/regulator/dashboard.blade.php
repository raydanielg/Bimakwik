                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="progress" style="height: 5px; width: 100px;">
                                                <div class="progress-bar bg-primary" role="progressbar" style="width: {{ min(($insurer->customer_policies_count ?? 0) / max($activePolicies ?? 1, 1) * 100, 100) }}%"></div>
                                            </div>
                                            <span class="x-small">{{ number_format(($insurer->customer_policies_count ?? 0) / max($activePolicies ?? 1, 1) * 100, 1) }}%</span>
                                        </td>
