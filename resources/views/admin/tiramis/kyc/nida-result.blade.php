...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-1">NIDA Verification Result</h4>
        <small class="text-muted">NIDA: {{ $nida_number }}</small>
    </div>
    <div>
        <a href="{{ route('admin.tiramis.kyc.nida.form') }}" class="btn btn-outline-secondary btn-sm rounded-pill px-3">
...
<div class="row">
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div>{{ $d['identity_type'] ?? 'NIDA' }}</div>
                    </div>
                    <div class="col-md-6">
                        <small class="text-muted">Identity Number</small>
                        <div><code>{{ $d['identity_number'] ?? $nida_number }}</code></div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div>{{ $d['marital_status'] ?? 'N/A' }}</div>
                    </div>
                    <div class="col-md-6">
                        <small class="text-muted">Occupation</small>
                        <div>{{ $d['occupation'] ?? 'N/A' }}</div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div>{{ $d['street'] ?? 'N/A' }}</div>
                    </div>
                    <div class="col-md-6">
                        <small class="text-muted">Postal Code</small>
                        <div>{{ $d['postal_code'] ?? 'N/A' }}</div>
                    </div>
                    <div class="col-12">
    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                <a href="{{ route('admin.tiramis.kyc.nida.form') }}" class="btn btn-outline-primary w-100 rounded-pill mb-2">
                    <i class="bi bi-search me-1"></i> Verify Another NIDA
                </a>
