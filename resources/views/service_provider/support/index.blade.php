...
@section('dashboard_title', 'Support')

@section('dashboard_content')
<div class="card border-0 shadow-sm p-4 mb-4">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
        <div>
            <h5 class="fw-bold mb-2">Provider Support</h5>
            <p class="text-muted mb-0">Access support tickets, escalation channels, and operational assistance.</p>
        </div>
