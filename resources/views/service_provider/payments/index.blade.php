...
@section('dashboard_title', 'Payments')

@section('dashboard_content')
<div class="card border-0 shadow-sm p-4 mb-4">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
        <div>
            <h5 class="fw-bold mb-2">Payment Reconciliation</h5>
            <p class="text-muted mb-0">Monitor approved payouts, payment cycles, and settlement reconciliation.</p>
        </div>
