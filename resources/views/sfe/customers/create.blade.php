...
@section('dashboard_title', 'Add Customer')

@section('dashboard_content')
<div class="card border-0 shadow-sm p-4 mb-4">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
        <div>
            <h5 class="fw-bold mb-2">Create New Customer</h5>
            <p class="text-muted mb-0">Capture onboarding details and initiate customer registration.</p>
        </div>
