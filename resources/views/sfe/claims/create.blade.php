...
@section('dashboard_title', 'Submit Claim')

@section('dashboard_content')
<div class="card border-0 shadow-sm p-4 mb-4">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
        <div>
            <h5 class="fw-bold mb-2">Submit Customer Claim</h5>
            <p class="text-muted mb-0">Initiate a new claim submission with required claim details.</p>
        </div>
