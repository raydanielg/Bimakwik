...
@section('dashboard_title', 'SFE Claims')
...
<div class="row g-4 mb-4">
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm p-4 h-100">
            <div class="text-muted small text-uppercase">Approved Value</div>
...
<div class="card border-0 shadow-sm p-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h6 class="fw-bold mb-0">Claims Tracking</h6>
        <a href="{{ route('sfe.claims.submit') }}" class="btn btn-sm btn-primary">Submit Claim</a>
    </div>
    <div class="table-responsive">
        <table class="table table-hover align-middle small">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-muted">No claims found yet.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
