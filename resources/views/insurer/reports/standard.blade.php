...
<div class="container-fluid py-4">
    @include('insurer._partials.page-header', [
        ...
        'subtitle' => 'Access pre-built regulatory and operational reports',
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white border-0 py-3">
            <h5 class="mb-0">Available Standard Reports</h5>
        </div>
        <div class="card-body">
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-3">
                                <div class="bg-secondary bg-opacity-10 p-2 rounded me-2">
                                    <i class="bi bi-building-fill text-secondary fs-5"></i>
                                </div>
