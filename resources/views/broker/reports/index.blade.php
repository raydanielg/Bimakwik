...
<div class="container-fluid py-4">
    @include('broker._partials.page-header', [
        'title' => 'Reports',
        'subtitle' => 'View and generate performance reports',
                ...
                <div class="col-md-4 mb-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('broker.reports.generate') }}">
                                @csrf
        ...
        <div class="card-header bg-white border-0 py-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group btn-group-sm">
                    <a href="{{ route('broker.reports.export') }}" class="btn btn-outline-primary"><i class="bi bi-download me-1"></i> Export All</a>
                </div>
            </div>
        </div>
        <div class="card-body">
                        ...
                        <tbody>
                            @foreach($reports as $report)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('broker.reports.download', $report) }}" class="btn btn-outline-primary" title="Download"><i class="bi bi-download"></i></a>
                                            <a href="{{ route('broker.reports.view', $report) }}" class="btn btn-outline-secondary" title="View"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
