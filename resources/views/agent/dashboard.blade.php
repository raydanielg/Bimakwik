...
<div class="container-fluid py-4">
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-4">
                    ...
                    <h4 class="fw-bold mb-0 stat-count">TZS {{ number_format($totalCommission, 0) }}</h4>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-4">
                    ...
                    <h4 class="fw-bold mb-0 stat-count">TZS {{ number_format($pendingCommission, 0) }}</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4">
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0 py-3">
                    <h6 class="fw-bold mb-0">Commission Summary</h6>
                </div>
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-6 mb-3">
                            <h3 class="fw-bold text-success">TZS {{ number_format($totalCommission, 0) }}</h3>
                            <small class="text-muted">Total Earned</small>
                        </div>
                        <div class="col-6 mb-3">
                            <h3 class="fw-bold text-warning">TZS {{ number_format($pendingCommission, 0) }}</h3>
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-6 mb-3">
                            <h3 class="fw-bold text-primary">{{ $totalClaims }}</h3>
                            <small class="text-muted">Total Claims</small>
                        </div>
                        <div class="col-6 mb-3">
                            <h3 class="fw-bold text-info">{{ $activePolicies }}</h3>
