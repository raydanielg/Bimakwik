...
@section('dashboard_title', 'API Testing')

@section('dashboard_content')
<div class="card border-0 shadow-sm p-4 mb-4">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
        <div>
            <h5 class="fw-bold mb-2">Testing and Validation</h5>
            <p class="text-muted mb-0">Test endpoint behavior and validate payload handling.</p>
        </div>
