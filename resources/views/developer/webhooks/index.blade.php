...
@section('dashboard_title', 'Webhooks')

@section('dashboard_content')
<div class="card border-0 shadow-sm p-4 mb-4">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
        <div>
            <h5 class="fw-bold mb-2">Webhook Management</h5>
            <p class="text-muted mb-0">Configure callback URLs and monitor delivery status.</p>
        </div>
