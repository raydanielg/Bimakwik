...
@section('dashboard_title', 'Sandbox')

@section('dashboard_content')
<div class="card border-0 shadow-sm p-4 mb-4">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
        <div>
            <h5 class="fw-bold mb-2">Sandbox Environment</h5>
            <p class="text-muted mb-0">Use a safe environment for integration development and testing.</p>
        </div>
