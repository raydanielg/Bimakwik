...
@section('dashboard_title', 'Documentation')

@section('dashboard_content')
<div class="card border-0 shadow-sm p-4 mb-4">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
        <div>
            <h5 class="fw-bold mb-2">Developer Documentation</h5>
            <p class="text-muted mb-0">Access integration guides, references, and onboarding resources.</p>
        </div>
