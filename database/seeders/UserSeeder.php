...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        $users = [
            ...
            ['name' => 'Agent', 'email' => 'agent@bimakwik.com', 'phone_number' => '0713888999', 'password' => Hash::make('password'), 'role' => 'agent'],
            ['name' => 'SFE Executive', 'email' => 'sfe@bimakwik.com', 'phone_number' => '0713888001', 'password' => Hash::make('password'), 'role' => 'sfe'],
            ['name' => 'Bancassurance Agent', 'email' => 'bancassurance@bimakwik.com', 'phone_number' => '0713888002', 'password' => Hash::make('password'), 'role' => 'bancassurance'],
